// Generated by gencpp from file mcuserial_msgs/TopicInfo.msg
// DO NOT EDIT!


#ifndef MCUSERIAL_MSGS_MESSAGE_TOPICINFO_H
#define MCUSERIAL_MSGS_MESSAGE_TOPICINFO_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> const> ConstPtr;

}; // struct TopicInfo_

typedef ::mcuserial_msgs::TopicInfo_<std::allocator<void> > TopicInfo;

typedef boost::shared_ptr< ::mcuserial_msgs::TopicInfo > TopicInfoPtr;
typedef boost::shared_ptr< ::mcuserial_msgs::TopicInfo const> TopicInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::mcuserial_msgs::TopicInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::mcuserial_msgs::TopicInfo_<ContainerAllocator1> & lhs, const ::mcuserial_msgs::TopicInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::mcuserial_msgs::TopicInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0ad51f88fc44892fULL;
  static const uint64_t static_value2 = 0x8c10684077646005ULL;
};

template<class ContainerAllocator>
struct DataType< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::mcuserial_msgs::TopicInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mcuserial_msgs::TopicInfo_<ContainerAllocator>& v)
  {
    s << indent << "topic_id: ";
...
#endif // MCUSERIAL_MSGS_MESSAGE_TOPICINFO_H
