...
(cl:in-package mcuserial_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <TopicInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TopicInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mcuserial_msgs-msg:<TopicInfo> is deprecated: use mcuserial_msgs-msg:TopicInfo instead.")))

(cl:ensure-generic-function 'topic_id-val :lambda-list '(m))
(cl:defmethod topic_id-val ((m <TopicInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcuserial_msgs-msg:topic_id-val is deprecated.  Use mcuserial_msgs-msg:topic_id instead.")
  (topic_id m))

(cl:ensure-generic-function 'topic_name-val :lambda-list '(m))
(cl:defmethod topic_name-val ((m <TopicInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcuserial_msgs-msg:topic_name-val is deprecated.  Use mcuserial_msgs-msg:topic_name instead.")
  (topic_name m))

(cl:ensure-generic-function 'message_type-val :lambda-list '(m))
(cl:defmethod message_type-val ((m <TopicInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcuserial_msgs-msg:message_type-val is deprecated.  Use mcuserial_msgs-msg:message_type instead.")
  (message_type m))

(cl:ensure-generic-function 'md5sum-val :lambda-list '(m))
(cl:defmethod md5sum-val ((m <TopicInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcuserial_msgs-msg:md5sum-val is deprecated.  Use mcuserial_msgs-msg:md5sum instead.")
  (md5sum m))

(cl:ensure-generic-function 'buffer_size-val :lambda-list '(m))
(cl:defmethod buffer_size-val ((m <TopicInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcuserial_msgs-msg:buffer_size-val is deprecated.  Use mcuserial_msgs-msg:buffer_size instead.")
  (buffer_size m))
