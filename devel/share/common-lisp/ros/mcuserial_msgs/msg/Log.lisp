...
(cl:defmethod cl:initialize-instance :after ((m <Log>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Log)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mcuserial_msgs-msg:<Log> is deprecated: use mcuserial_msgs-msg:Log instead.")))

(cl:ensure-generic-function 'level-val :lambda-list '(m))
(cl:defmethod level-val ((m <Log>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcuserial_msgs-msg:level-val is deprecated.  Use mcuserial_msgs-msg:level instead.")
  (level m))

(cl:ensure-generic-function 'msg-val :lambda-list '(m))
(cl:defmethod msg-val ((m <Log>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcuserial_msgs-msg:msg-val is deprecated.  Use mcuserial_msgs-msg:msg instead.")
  (msg m))
