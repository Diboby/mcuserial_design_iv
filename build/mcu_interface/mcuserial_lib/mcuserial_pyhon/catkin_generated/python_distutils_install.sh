...
echo_and_run cd "/home/rokot1/design4_workspace/src/mcu_interface/mcuserial_lib/mcuserial_pyhon"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/rokot1/design4_workspace/src/mcu_interface/mcuserial_lib/mcuserial_pyhon/setup.py" \
     \
    build --build-base "/home/rokot1/design4_workspace/build/mcu_interface/mcuserial_lib/mcuserial_pyhon" \
    install \
    --root="${DESTDIR-/}" \
