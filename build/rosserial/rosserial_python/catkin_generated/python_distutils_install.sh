...
echo_and_run cd "/home/rokot1/design4_workspace/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/rokot1/design4_workspace/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/rokot1/design4_workspace/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
