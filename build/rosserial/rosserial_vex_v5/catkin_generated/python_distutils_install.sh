...
echo_and_run cd "/home/rokot1/design4_workspace/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/rokot1/design4_workspace/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/rokot1/design4_workspace/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
